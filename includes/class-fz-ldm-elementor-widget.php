...
class Elementor_Widget extends \Elementor\Widget_Base{
 ...
 protected function register_controls(){
  ...
  $this->add_control('light_track',['label'=>'Light track','type'=>\Elementor\Controls_Manager::COLOR,'selectors'=>['{{WRAPPER}} .fz-toggle'=>'background-color:{{VALUE}};']]);
  $this->add_control('dark_track',['label'=>'Dark track','type'=>\Elementor\Controls_Manager::COLOR,'selectors'=>['{{WRAPPER}} .fz-toggle'=>'--fz-dark-track:{{VALUE}};']]);
  $this->add_control('thumb_color',['label'=>'Thumb colour','type'=>\Elementor\Controls_Manager::COLOR,'selectors'=>['{{WRAPPER}} .fz-toggle__thumb'=>'background-color:{{VALUE}};']]);
 ...
 <button type="button" class="fz-toggle" data-fz-toggle aria-label="Switch to dark mode" aria-pressed="false"><span class="fz-toggle__icon" aria-hidden="true"><span class="fz-icon-sun">☀</span><span class="fz-icon-moon">☾</span></span><span class="fz-toggle__thumb"></span></button>
